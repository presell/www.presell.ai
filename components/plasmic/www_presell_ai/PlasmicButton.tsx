...
import sty from "./PlasmicButton.module.css"; // plasmic-import: CnJoQKF1JUjMXv/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__a56Qt)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__vmIk)}
                role={"img"}
              />
            ),
