...
import sty from "./PlasmicNavbar.module.css"; // plasmic-import: 1Ua3Zd0YazUX91/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__nzEWa)}
      >
        {true ? (
          <Logo
          ...
          >
            {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
              <Button
                ...
                endIcon={
                  <svg
                    className={classNames(projectcss.all, sty.svg__s7Ja)}
                    role={"img"}
                  />
                }
                link={"#" as const}
                startIcon={
                  <svg
                    className={classNames(projectcss.all, sty.svg___0Eafl)}
                    role={"img"}
                  />
                }
              >
            ...
            {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
              <Button
                ...
                endIcon={
                  <svg
                    className={classNames(projectcss.all, sty.svg___0IhwP)}
                    role={"img"}
                  />
                }
                link={"#" as const}
                startIcon={
                  <svg
                    className={classNames(projectcss.all, sty.svg__qKdWw)}
                    role={"img"}
                  />
                }
              >
            ...
            {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
              <Button
                className={classNames("__wab_instance", sty.button___8Shw)}
                color={"navLink" as const}
                endIcon={
                  <svg
                    className={classNames(projectcss.all, sty.svg___5QWSu)}
                    role={"img"}
                  />
                }
                link={"#" as const}
                startIcon={
                  <svg
                    className={classNames(projectcss.all, sty.svg___2KttX)}
                    role={"img"}
                  />
                }
              >
        ...
        {true ? (
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__b4UTg)}
          >
            {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
              <Button
            ...
            {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
              <Button
                className={classNames("__wab_instance", sty.button__t8Ni4)}
                color={"navLinkBlue" as const}
                endIcon={
                  <svg
                    className={classNames(projectcss.all, sty.svg__mQgNo)}
                    role={"img"}
                  />
                }
                link={"https://www.presell.ai/signup" as const}
                startIcon={
                  <svg
